          ...
          <div className="row">
            <div className="col">
              ...
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example3">Instrumental Item</label>
              </div>
            </div>
            <div className="col">
              {/* <!-- Name input --> */}
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example4">Music Item</label>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col">
              ...
              <div className="form-check form-switch">
                ...
                <label className="form-check-label" htmlFor="flexSwitchCheckChecked">Live Status</label>
              </div>
            </div>
          </div>
