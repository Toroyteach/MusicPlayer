        ...
        <div className="container">
          ...
          <div className="row ">
            <div className="col">
              ...
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example1">Title</label>
              </div>
            </div>
            <div className="col">
              {/* <!-- Email input --> */}
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example2">Artist</label>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col">
              ...
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example3">Songs Count</label>
              </div>
            </div>
            <div className="col">
              {/* <!-- Name input --> */}
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example4">Duration</label>
              </div>
            </div>
            <div className="col">
              {/* <!-- Name input --> */}
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example3">Date Created</label>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col">
              ...
              <div className="form-outline">
                <textarea className="form-control" id="textAreaExample1" rows="4"></textarea>
                <label className="form-label" htmlFor="textAreaExample">Comments</label>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col">
              ...
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example3">Cover Art</label>
              </div>
            </div>
            <div className="col">
              {/* <!-- Name input --> */}
              <div className="form-outline">
                ...
                <label className="form-label" htmlFor="form8Example4">Mix Upload</label>
              </div>
            </div>
          </div>
