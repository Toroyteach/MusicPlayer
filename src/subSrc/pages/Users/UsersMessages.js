              ...
              <div className="card" id="chat2">
                ...
                <div className="card-body" data-mdb-perfect-scrollbar="true" style={{ position: "relative", height: "60vh", overflow: "auto" }}>
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    ...
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">Hi</p>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">How are you ...???</p>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">What are you doing tomorrow? Can we come up a bar?</p>
                  ...
                  <div className="d-flex flex-row justify-content-start mb-4">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                      alt="avatar 1" style={{ width: "45px", height: "100%" }} />
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">Okay</p>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">We will go on Sunday?</p>
                  ...
                  <div className="d-flex flex-row justify-content-start mb-4">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                      alt="avatar 1" style={{ width: "45px", height: "100%" }} />
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">Okay i will meet
                        you on
                        Sandon Square</p>
                  ...
                  <div className="d-flex flex-row justify-content-start mb-4">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3-bg.webp"
                      alt="avatar 1" style={{ width: "45px", height: "100%" }} />
                    <div>
                      <p className="small p-2 ms-3 mb-1 rounded-3 userMessagesBG">Sorry I don't have. i changed my phone.</p>
