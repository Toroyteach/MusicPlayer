                ...
                <div className="col-lg-4 col-md-6 mt-4 mb-4">
                    <div className="card h-100">
                        ...
                        <div className="timeline timeline-one-side">
                            ...
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Quepasa</h6>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">22 DEC 7:20 PM</p>
                            </div>
                            </div>
                            <div className="timeline-block mb-3">
                            <span className="timeline-step">
                                <i className="material-icons text-danger text-gradient"><svg xmlns="http://www.w3.org/2000/svg" transform="translate(0,-3)" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg></i>
                            </span>
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Magnifico</h6>
                    ...
                    <div className="card h-100">
                        ...
                        <div className="timeline timeline-one-side">
                            ...
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Mamba</h6>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">22 DEC 7:20 PM</p>
                            </div>
                            </div>
                            <div className="timeline-block mb-3">
                            ...
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Byte</h6>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">21 DEC 11 PM</p>
                            </div>
                            </div>
                        </div>
                    ...
                    <div className="card h-100">
                        ...
                        <div className="timeline timeline-one-side">
                            ...
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Kshmr Secrets</h6>
                            </div>
                            </div>
                            <div className="timeline-block mb-3">
                            <span className="timeline-step">
                                <i className="material-icons text-danger text-gradient"><svg xmlns="http://www.w3.org/2000/svg" transform="translate(0,-3)" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 3v9.28c-.47-.17-.97-.28-1.5-.28C8.01 12 6 14.01 6 16.5S8.01 21 10.5 21c2.31 0 4.2-1.75 4.45-4H15V6h4V3h-7z"/></svg></i>
                            </span>
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Tiesto Business</h6>
                            </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div className="card h-100">
                        ...
                        <div className="timeline timeline-one-side">
                            ...
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">QuePasa</h6>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0"> 10th July 2022 9:43:49pm</p>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veniam quisquam voluptas quis? Cupiditate quo non corrupti eos laboriosam expedita consequatur iste, beatae quas quaerat ex, laborum fugit harum perferendis accusantium.</p>
                            </div>
                            </div>
                            <div className="timeline-block mb-3">
                            <span className="timeline-step">
                                <i className="material-icons text-danger text-gradient"><svg xmlns="http://www.w3.org/2000/svg" transform="translate(0,-3)" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none"/><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg></i>
                            </span>
                            <div className="timeline-content">
                                <h6 className="text-dark text-sm font-weight-bold mb-0">Byte</h6>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0"> 10th July 2022 9:43:49pm</p>
                                <p className="text-secondary font-weight-bold text-xs mt-1 mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem necessitatibus suscipit amet soluta numquam asperiores illum, voluptatem, vero libero cum delectus ex deserunt obcaecati quia voluptatibus accusamus veritatis, tempora expedita.</p>
                            </div>
                            </div>
                        </div>
                        </div>
