            ...
            <div class="row">
                ...
                {/* <!-- Name input --> */}
                    <div class="form-outline">
                        ...
                        <label class="form-label" for="form8Example3">Songs Count</label>
                    </div>
                </div>
                <div class="col">
                {/* <!-- Name input --> */}
                    <div class="form-outline">
                        <input type="number" id="form8Example4" class="form-control" />
                ...
                <div class="col">
                    {/* <!-- Name input --> */}
                    <div class="form-outline">
                        <input type="date" id="form8Example3" class="form-control" />
                        <label class="form-label" for="form8Example3">Date Created</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-outline">
                        ...
                        <label class="form-label" for="form8Example3">Cover Art</label>
                    </div>
                </div>
                <div class="col">
                {/* <!-- Name input --> */}
                    <div class="form-outline">
                        ...
                        <label class="form-label" for="form8Example4">Mix Upload</label>
                    </div>
                </div>
            </div>
