...
//use auth for logout
import useAuth from '../backend/authContext/useAuth.js';
                  ...
                  <div class="sl-nav">
                    ...
                    <ul>
                      <li>
                        ...
                        <ul>
                          <li><i class="sl-flag flag-de"><div id="germany"></div></i> <span>Deutsch</span></li>
                          <li><i class="sl-flag flag-gb"><div id="germany"></div></i> <span>Englisch</span></li>
                          <li><i class="sl-flag flag-au"><div id="germany"></div></i> <span>Australia</span></li>
                          <li><i class="sl-flag flag-usa"><div id="germany"></div></i> <span>USA</span></li>
                        </ul>
                      </li>
                    </ul>
                  </div>
